...
<div class="container mx-auto p-6 mt-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="project?action=create" class="bg-[#F4A261] text-white p-6 sm:p-3 rounded-lg shadow-md hover:bg-[#A8D5BA] hover:text-[#1A3C34] transition duration-300 sm:text-sm">
        ...
        <table class="w-full bg-white rounded-lg shadow-md">
            ...
            <c:forEach var="project" items="${projects}">
                <tr class="border-b hover:bg-[#A8D5BA]/20 transition duration-300">
                    <td class="p-6 sm:p-3 sm:text-sm">${project.id}</td>
                    <td class="p-6 sm:p-3 sm:text-sm">${project.name}</td>
                    <td class="p-6 sm:p-3 sm:text-sm">${project.description}</td>
                    <td class="p-6 sm:p-3 sm:text-sm">${project.startDate}</td>
                    <td class="p-6 sm:p-3 sm:text-sm">${project.endDate}</td>
                    <td class="p-6 sm:p-3 sm:text-sm">${project.budget}</td>
