 ...
 * Generated at: 2025-03-17 12:18:54 UTC
...
public final class taskList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <h1 class=\"text-2xl font-bold sm:text-xl\">ConstructionXpert <i class=\"fas fa-hammer\"></i></h1>\r\n");
      ...
      out.write("            </button>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div id=\"menu\" class=\"hidden md:flex md:space-x-4 flex-col md:flex-row absolute md:static top-16 left-0 w-full md:w-auto bg-[#2D6A4F] md:bg-transparent p-4 md:p-0 z-10\">\r\n");
      ...
      out.write("        <a href=\"task?action=create&projectId=${param.projectId}\" class=\"bg-[#F4A261] text-white p-6 sm:p-3 rounded-lg shadow-md hover:bg-[#A8D5BA] hover:text-[#1A3C34] transition duration-300 sm:text-sm\">\r\n");
      out.write("            <i class=\"fas fa-plus\"></i> Add Task\r\n");
      out.write("        </a>\r\n");
      out.write("    </div>\r\n");
      out.write("    <div class=\"overflow-x-auto\">\r\n");
      out.write("        <table class=\"w-full bg-white rounded-lg shadow-md\">\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /taskList.jsp(68,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("task");
    // /taskList.jsp(68,12) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/taskList.jsp(68,12) '${tasks}'",_jsp_getExpressionFactory().createValueExpression("${tasks}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">${task.id}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">${task.description}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">${task.startDate}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">${task.endDate}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">\r\n");
