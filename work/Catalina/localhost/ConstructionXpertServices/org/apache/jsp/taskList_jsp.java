 ...
 * Generated at: 2025-03-18 10:50:17 UTC
...
public final class taskList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <h2 class=\"text-3xl font-bold text-[#2D6A4F] sm:text-2xl\">Tasks for Project ID: ${param.projectId}</h2>\r\n");
      out.write("        <a href=\"taskCreate.jsp?action=create&projectId=${param.projectId}\" class=\"bg-[#F4A261] text-white p-6 sm:p-3 rounded-lg shadow-md hover:bg-[#A8D5BA] hover:text-[#1A3C34] transition duration-300 sm:text-sm\">\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /taskList.jsp(104,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("task");
    // /taskList.jsp(104,12) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/taskList.jsp(104,12) '${tasks}'",_jsp_getExpressionFactory().createValueExpression("${tasks}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\" data-label=\"ID\">${task.id}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\" data-label=\"Description\">${task.description}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\" data-label=\"Start Date\">${task.startDate}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\" data-label=\"End Date\">${task.endDate}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\" data-label=\"Actions\">\r\n");
          out.write("                        <a href=\"task?action=update&id=${task.id}&projectId=${param.projectId}\" class=\"text-[#F4A261] hover:text-[#2D6A4F] mr-6 sm:mr-2\"><i class=\"fas fa-edit\"></i></a>\r\n");
          out.write("                        <a href=\"task?action=delete&id=${task.id}&projectId=${param.projectId}\" class=\"text-[#2D6A4F] hover:text-[#F4A261]\"><i class=\"fas fa-trash\"></i></a>\r\n");
          out.write("                    </td>\r\n");
          out.write("                </tr>\r\n");
          out.write("            ");
