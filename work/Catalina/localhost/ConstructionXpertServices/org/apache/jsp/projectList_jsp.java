 ...
 * Generated at: 2025-03-17 12:14:18 UTC
...
public final class projectList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <a href=\"project?action=create\" class=\"bg-[#F4A261] text-white p-6 sm:p-3 rounded-lg shadow-md hover:bg-[#A8D5BA] hover:text-[#1A3C34] transition duration-300 sm:text-sm\">\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /projectList.jsp(70,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("project");
    // /projectList.jsp(70,12) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/projectList.jsp(70,12) '${projects}'",_jsp_getExpressionFactory().createValueExpression("${projects}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">${project.id}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">${project.name}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">${project.description}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">${project.startDate}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">${project.endDate}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\">${project.budget}</td>\r\n");
