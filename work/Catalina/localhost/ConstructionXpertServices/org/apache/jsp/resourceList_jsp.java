 ...
 * Generated at: 2025-03-18 10:50:30 UTC
...
public final class resourceList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <a href=\"projectList.jsp\" class=\"block md:inline-block hover:text-[#A8D5BA] transition duration-200 sm:text-sm py-3 md:py-0 px-4 rounded-lg hover:bg-[#A8D5BA]/20\">Projects</a>\r\n");
      ...
      out.write("        <a href=\"resourceCreate.jsp\" class=\"bg-[#F4A261] text-white p-6 sm:p-3 rounded-lg shadow-md hover:bg-[#A8D5BA] hover:text-[#1A3C34] transition duration-300 sm:text-sm\">\r\n");
      ...
      out.write("                <th class=\"p-6 sm:p-3 sm:text-sm\">Type</th>\r\n");
      out.write("                <th class=\"p-6 sm:p-3 sm:text-sm\">Quantity</th>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /resourceList.jsp(104,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("resource");
    // /resourceList.jsp(104,12) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/resourceList.jsp(104,12) '${resources}'",_jsp_getExpressionFactory().createValueExpression("${resources}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\" data-label=\"ID\">${resource.id}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\" data-label=\"Name\">${resource.name}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\" data-label=\"Type\">${resource.type}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\" data-label=\"Quantity\">${resource.quantity}</td>\r\n");
          out.write("                    <td class=\"p-6 sm:p-3 sm:text-sm\" data-label=\"Actions\">\r\n");
          out.write("                        <a href=\"resource?action=update&id=${resource.id}\" class=\"text-[#F4A261] hover:text-[#2D6A4F] mr-6 sm:mr-2\"><i class=\"fas fa-edit\"></i></a>\r\n");
          out.write("                        <a href=\"resource?action=delete&id=${resource.id}\" class=\"text-[#2D6A4F] hover:text-[#F4A261] mr-6 sm:mr-2\"><i class=\"fas fa-trash\"></i></a>\r\n");
          out.write("                        <a href=\"resource?action=updateQuantity&id=${resource.id}\" class=\"text-[#F4A261] hover:text-[#2D6A4F]\"><i class=\"fas fa-sync\"></i></a>\r\n");
          out.write("                    </td>\r\n");
          out.write("                </tr>\r\n");
          out.write("            ");
